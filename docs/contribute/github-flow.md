<!-- Space: Projects -->
<!-- Parent: ZshTfenv -->
<!-- Title: Contributing GithubFlow ZshTfenv -->
<!-- Label: ZshTfenv -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-tfenv project on [GitHub](https://github.com/hadenlabs/zsh-tfenv), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-tfenv/pulls).
...
To follow the instructions in this guide and start contributing to zsh-tfenv project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-tfenv.git
```

Now your **upstream** points to **hadenlabs/zsh-tfenv**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-tfenv
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-tfenv/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
